...
class Blockchain:
    ...
    def __init__(self):
        ...
        self.create_block(proof=1, previous_hash='0',contents=['0x24ab0fe2de908c503e9b3b5f0c716c4a38851adc20e06ac3313ffe712ecb848e0',1])
...
def get_next_block():
    return str(blockchain.current_block),200
